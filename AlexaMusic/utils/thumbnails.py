...
async def gen_thumb(videoid, user_id, theme):
    ...
    try:
        ...
        try:
            text_w, text_h = draw.textsize(f"MUSIC STREAM IS PLAYING OP", font=font)
            draw.text(
                ((1280 - text_w) / 2, 30),
                f"MUSIC STREAM IS PLAYING OP",
                fill="red",
                font=font,
            )
            text_w, text_h = draw.textsize(
                f"Music One Of The Most Advanced Music Bot", font=arial
            )
            draw.text(
                ((1280 - text_w) / 2, 80),
                f"Music One Of The Most Advanced Music Bot",
                fill="green",
                font=arial,
            )
            if para[0]:
            ...
            pass
        text_w, text_h = draw.textsize(f"YouTube: Music", font=arial)
        draw.text(
            ((1280 - text_w) / 2, 620),
            f"YouTube: Music",
            fill="white",
...
async def gen_qthumb(videoid, user_id, theme):
    ...
    try:
        ...
        para = textwrap.wrap(title, width=32)
        try:
            text_w, text_h = draw.textsize(f"MUSIC STREAM ADDED THIS SONG TO QUEUE", font=font)
            draw.text(
                ((1280 - text_w) / 2, 30),
                f"MUSIC STREAM ADDED THIS SONG",
                fill="red",
                font=font,
            )
            text_w, text_h = draw.textsize(
                f"Music Stream One Of The Most Advanced Music Bot", font=arial
            )
            draw.text(
                ((1280 - text_w) / 2, 80),
                f"Music Stream One Of The Most Advanced Music Bot",
                fill="green",
                font=arial,
            )
            if para[0]:

...
async def on_new_chat_members(client: Client, message: Message):
    if (await client.get_me()).id in [user.id for user in message.new_chat_members]:
        added_by = message.from_user.first_name if message.from_user else "Pengguna Tidak Dikenal"
        ...
        lemda_text = f"Bot Ditambahkan ke grup baru ..\n\n┏━━━━━━━━━━━━━━━━━┓\n┣ **Chat** › : {matlabi_jhanto}\n┣ **Chat Id** › : {chat_id}\n┣ **Username** › : {chatusername}\n┣ **Total Chat** › : {served_chats}\n┣ **Ditambahkan Oleh** › :\n┗━━━ {added_by}"
